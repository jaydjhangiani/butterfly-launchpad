    ...
    <div className="min-h-screen relative overflow-hidden bg-primary-foreground">
      ...
      <section className="relative z-10 mx-[25px] ml-[25px] mb-[25px] bg-[#f8e8e8]">
        <div className="px-6 py-12 md:py-14 max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-muted-foreground text-base md:text-lg py-0 px-[50px]">
            It's similar to what they say about how if you think 60 seconds is too less, try a plank.
          </p>
          <p className="text-muted-foreground text-base px-[50px]">
          ...
          <p className="text-foreground font-semibold text-base px-[40px]">
